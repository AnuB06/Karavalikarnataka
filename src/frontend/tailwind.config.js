  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        banking: "0 4px 20px -4px rgba(0,0,0,0.12), 0 1px 4px rgba(0,0,0,0.06)",
        "banking-lg": "0 16px 48px -12px rgba(0,0,0,0.22), 0 4px 12px rgba(0,0,0,0.1)",
        gold: "0 4px 20px -4px oklch(0.78 0.14 72 / 0.4)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
